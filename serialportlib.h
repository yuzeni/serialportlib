...
#define SERIALPORTLIB_MAX_SERIALPORT_IDX 1024
...
SPAPI uint64_t serialport_read_bytes(uint32_t sp_idx, void* out_buffer, uint64_t out_size);
...
SPAPI bool serialport_skip_to_next_delimiter(uint32_t sp_idx, void* delimiter, uint64_t delimiter_size);
